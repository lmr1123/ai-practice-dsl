...
const checks = [
  ...
  ["资源版本已更新", html.includes("app.js?v=20260506-composer") && html.includes("styles.css?v=20260506-composer")],
  ...
  ["训练目标展示", app.includes("targetBrief") && app.includes("scenario.prep.goals")],
